    ...
    return (
        <div>
            <div className="overflow-hidden rounded-lg cursor-pointer relative">
                <img className="rounded-lg transition-transform duration-500 ease-in-out hover:scale-110 hover:shadow-lg overflow-hidden xl:w-[280px] lg:w-[225px] md:w-[200px] w-[200px] xl:h-[350px] lg:h-[300px] md:h-[280px] h-[250px]" src={image} alt="" />
